...
def drift_corr_image_list_merge(file_list, output_folder, course_ch, fine_ch, file_list2 = None):
    '''
    Drift corrects in 3D by a distributed register_translation of all files in the list provided. 
    Typically this list is generated by drift_corr_multi or drift_corr_mypic.
    Only CZI files at the moment.
    ...
    #Add images in file_list2 as extra channels on file_list
    if not file_list2 is None:
        template_image_ch2 = ip.read_czi_image(template_path)
