...
class FileConverter():
    ...
    def gen_folder_list(self):
        ...
        folders = [self.input_folder+os.sep+folder for folder in os.listdir(self.input_folder)]
    ...
    def run_conversion(self):
        ...
        for pos in tqdm.tqdm(pos_list):
            ...
            Parallel(n_jobs=-1, prefer='threads', verbose=10)(delayed(self.single_image_to_zarr)(multiscale_level, self.fnarr, pos_index, t_idx) for t_idx in range(T))
